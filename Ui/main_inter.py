...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(90, 70, 501, 311))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.btn_add = QtWidgets.QPushButton(self.centralwidget)
        self.btn_add.setGeometry(QtCore.QRect(140, 410, 75, 23))
        self.btn_add.setObjectName("btn_add")
        self.btn_change = QtWidgets.QPushButton(self.centralwidget)
        self.btn_change.setEnabled(False)
        self.btn_change.setGeometry(QtCore.QRect(430, 410, 91, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_change.setText(_translate("MainWindow", "Редактировать"))
